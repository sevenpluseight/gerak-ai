...
const FileUpload = () => {
  ...
  // Redirect when all files are processed
  useEffect(() => {
        ...
        >
          <div className="card-body">
            ...
            <p className={`text-sm ${isDark ? "text-gray-400" : "text-gray-600"}`}>
              Upload up to <strong>5 PDF files</strong>. Each file max <strong>1GB</strong>. Total max <strong>5GB</strong>.
            </p>

            <Alert
              type="info"
              message="Accepted file types: PDF only."
            />
            ...
            <div className="card-actions justify-end mt-6">
              <button className="btn bg-purple-600 text-white" onClick={handleStartPrediction}>
                Start Prediction
              </button>
            </div>
          </div>
